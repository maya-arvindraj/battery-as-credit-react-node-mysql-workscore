...
export function Badge({
  ...
  return (
    <span
      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-600 ${variants[variant]}`}
    >
      {children}
    </span>
  )
...
export function StatCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
      ...
      <div className="text-2xl font-display font-700 text-slate-900">
        {value}
      </div>
      <div className="text-sm text-slate-500 mt-0.5">{label}</div>
      {sub && (
        <div className="text-xs text-green-600 mt-1 font-500">
          {sub}
        </div>
      )}
    </div>
        ...
        {RIDER_NAV.map(({ key, label, icon: Icon }) => (
          <button
            ...
            className={`
              ...
              rounded-xl text-sm font-500 transition-all
              ${
                currentPage === key
      ...
      <div className="p-3 border-t border-slate-100 space-y-1">
        ...
        {RIDER_BOTTOM_NAV.map(({ key, label, icon: Icon }) => (
          <button
            ...
            className="
              w-full flex items-center gap-3 px-3 py-2.5
              rounded-xl text-sm font-500 text-slate-500
              hover:bg-slate-50 hover:text-slate-900 transition-all
            "
          >
        ...
        <button
          ...
          className="
            w-full flex items-center gap-3 px-3 py-2.5
            rounded-xl text-sm font-500 text-slate-400
    ...
    <aside className="w-60 bg-white border-r border-slate-200 flex flex-col shrink-0">
      ...
      <div className="p-5 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="font-display font-700 text-slate-900 text-sm leading-tight">
              Battery-as-Credit
            </div>
